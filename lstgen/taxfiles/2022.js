function Lohnsteuer2022Big(params) {
 ...
 */
Lohnsteuer2022Big.prototype.MAIN = function() {
    this.MPARA();
    this.MRE4JL();
...
Lohnsteuer2022Big.prototype.MPARA = function() {
    if (this.KRV < 2) {
        if (this.KRV == 0) {
            this.BBGRV = new BigDecimal(84600);
        } else {
            this.BBGRV = new BigDecimal(81000);
        }
        this.RVSATZAN = BigDecimal.valueOf(0.093);
        this.TBSVORV = BigDecimal.valueOf(0.88);
    }
    this.BBGKVPV = new BigDecimal(58050);
    this.bd = new BigDecimal(2);
    this.KVSATZAN = this.KVZ.divide(this.bd).divide(Lohnsteuer2022Big.ZAHL100).add(BigDecimal.valueOf(0.07));
    ...
    if (this.PVZ == 1) {
        this.PVSATZAN = this.PVSATZAN.add(BigDecimal.valueOf(0.0035));
    }
    this.W1STKL5 = new BigDecimal(11793);
    this.W2STKL5 = new BigDecimal(29298);
    this.W3STKL5 = new BigDecimal(222260);
    this.GFB = new BigDecimal(10347);
...
Lohnsteuer2022Big.prototype.MRE4JL = function() {
    if (this.LZZ == 1) {
        this.ZRE4J = this.RE4.divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
        this.ZVBEZJ = this.VBEZ.divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
        this.JLFREIB = this.LZZFREIB.divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
        this.JLHINZU = this.LZZHINZU.divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
    } else {
        if (this.LZZ == 2) {
            this.ZRE4J = this.RE4.multiply(Lohnsteuer2022Big.ZAHL12).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
            this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2022Big.ZAHL12).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
            this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2022Big.ZAHL12).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
            this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2022Big.ZAHL12).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
        } else {
            if (this.LZZ == 3) {
                this.ZRE4J = this.RE4.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL700, 2, BigDecimal.ROUND_DOWN);
                this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL700, 2, BigDecimal.ROUND_DOWN);
                this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL700, 2, BigDecimal.ROUND_DOWN);
                this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL700, 2, BigDecimal.ROUND_DOWN);
            } else {
                this.ZRE4J = this.RE4.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
                this.ZVBEZJ = this.VBEZ.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
                this.JLFREIB = this.LZZFREIB.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
                this.JLHINZU = this.LZZHINZU.multiply(Lohnsteuer2022Big.ZAHL360).divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
            }
        }
    }
    if (this.af == 0) {
...
Lohnsteuer2022Big.prototype.MRE4 = function() {
    if (this.ZVBEZJ.compareTo(BigDecimal.ZERO()) == 0) {
        ...
        if (this.LZZ == 1) {
            ...
            this.HFVB = Lohnsteuer2022Big.TAB2[this.J].divide(Lohnsteuer2022Big.ZAHL12).multiply(BigDecimal.valueOf(this.ZMVB));
            this.FVBZ = Lohnsteuer2022Big.TAB3[this.J].divide(Lohnsteuer2022Big.ZAHL12).multiply(BigDecimal.valueOf(this.ZMVB)).setScale(0, BigDecimal.ROUND_UP);
        } else {
            this.VBEZB = this.VBEZM.multiply(Lohnsteuer2022Big.ZAHL12).add(this.VBEZS).setScale(2, BigDecimal.ROUND_DOWN);
            this.HFVB = Lohnsteuer2022Big.TAB2[this.J];
            this.FVBZ = Lohnsteuer2022Big.TAB3[this.J];
        }
        this.FVB = this.VBEZB.multiply(Lohnsteuer2022Big.TAB1[this.J]).divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_UP);
        ...
        this.FVBSO = this.FVB.add(this.VBEZBSO.multiply(Lohnsteuer2022Big.TAB1[this.J]).divide(Lohnsteuer2022Big.ZAHL100)).setScale(2, BigDecimal.ROUND_UP);
        if (this.FVBSO.compareTo(Lohnsteuer2022Big.TAB2[this.J]) == 1) {
            this.FVBSO = Lohnsteuer2022Big.TAB2[this.J];
        }
        this.HFVBZSO = this.VBEZB.add(this.VBEZBSO).divide(Lohnsteuer2022Big.ZAHL100).subtract(this.FVBSO).setScale(2, BigDecimal.ROUND_DOWN);
        this.FVBZSO = this.FVBZ.add(this.VBEZBSO.divide(Lohnsteuer2022Big.ZAHL100)).setScale(0, BigDecimal.ROUND_UP);
        if (this.FVBZSO.compareTo(this.HFVBZSO) == 1) {
            this.FVBZSO = this.HFVBZSO.setScale(0, BigDecimal.ROUND_UP);
        }
        if (this.FVBZSO.compareTo(Lohnsteuer2022Big.TAB3[this.J]) == 1) {
            this.FVBZSO = Lohnsteuer2022Big.TAB3[this.J];
        }
        this.HFVBZ = this.VBEZB.divide(Lohnsteuer2022Big.ZAHL100).subtract(this.FVB).setScale(2, BigDecimal.ROUND_DOWN);
...
Lohnsteuer2022Big.prototype.MRE4ALTE = function() {
    if (this.ALTER1 == 0) {
        ...
        this.ALTE = this.BMG.multiply(Lohnsteuer2022Big.TAB4[this.K]).setScale(0, BigDecimal.ROUND_UP);
        this.HBALTE = Lohnsteuer2022Big.TAB5[this.K];
...
Lohnsteuer2022Big.prototype.MRE4ABZ = function() {
    ...
    if (this.KENNVMT == 2) {
        this.ZRE4VP = this.ZRE4VP.subtract(this.ENTSCH.divide(Lohnsteuer2022Big.ZAHL100)).setScale(2, BigDecimal.ROUND_DOWN);
    }
...
Lohnsteuer2022Big.prototype.MBERECH = function() {
    this.MZTABFB();
    this.VFRB = this.ANP.add(this.FVB.add(this.FVBZ)).multiply(Lohnsteuer2022Big.ZAHL100).setScale(0, BigDecimal.ROUND_DOWN);
    this.MLSTJAHR();
    this.WVFRB = this.ZVE.subtract(this.GFB).multiply(Lohnsteuer2022Big.ZAHL100).setScale(0, BigDecimal.ROUND_DOWN);
...
Lohnsteuer2022Big.prototype.MZTABFB = function() {
    ...
    if (this.STKL < 6) {
        if (this.ZRE4.compareTo(this.ZVBEZ) == 1) {
            if (this.ZRE4.subtract(this.ZVBEZ).compareTo(BigDecimal.valueOf(1200)) == -1) {
                this.ANP = this.ANP.add(this.ZRE4).subtract(this.ZVBEZ).setScale(0, BigDecimal.ROUND_UP);
            } else {
                this.ANP = this.ANP.add(BigDecimal.valueOf(1200));
            }
        }
    }
    this.KZTAB = 1;
...
Lohnsteuer2022Big.prototype.MLSTJAHR = function() {
    ...
    if (this.KENNVMT != 1) {
        ...
        this.ZVE = this.ZRE4.subtract(this.ZTABFB).subtract(this.VSP).subtract(this.VMT.divide(Lohnsteuer2022Big.ZAHL100)).subtract(this.VKAPA.divide(Lohnsteuer2022Big.ZAHL100)).setScale(2, BigDecimal.ROUND_DOWN);
        if (this.ZVE.compareTo(BigDecimal.ZERO()) == -1) {
            this.ZVE = this.ZVE.add(this.VMT.divide(Lohnsteuer2022Big.ZAHL100)).add(this.VKAPA.divide(Lohnsteuer2022Big.ZAHL100)).divide(Lohnsteuer2022Big.ZAHL5).setScale(2, BigDecimal.ROUND_DOWN);
            this.UPMLST();
            this.ST = this.ST.multiply(Lohnsteuer2022Big.ZAHL5).setScale(0, BigDecimal.ROUND_DOWN);
        } else {
            this.UPMLST();
            this.STOVMT = this.ST;
            this.ZVE = this.ZVE.add(this.VMT.add(this.VKAPA).divide(Lohnsteuer2022Big.ZAHL500)).setScale(2, BigDecimal.ROUND_DOWN);
            this.UPMLST();
            this.ST = this.ST.subtract(this.STOVMT).multiply(Lohnsteuer2022Big.ZAHL5).add(this.STOVMT).setScale(0, BigDecimal.ROUND_DOWN);
        }
    }
}
...
Lohnsteuer2022Big.prototype.UPVKV = function() {
    if (this.PKV > 0) {
        if (this.VSP2.compareTo(this.VSP3) == 1) {
            this.VKV = this.VSP2.multiply(Lohnsteuer2022Big.ZAHL100);
        } else {
            this.VKV = this.VSP3.multiply(Lohnsteuer2022Big.ZAHL100);
        }
    } else {
...
Lohnsteuer2022Big.prototype.UPLSTLZZ = function() {
    this.JW = this.LSTJAHR.multiply(Lohnsteuer2022Big.ZAHL100);
    this.UPANTEIL();
...
Lohnsteuer2022Big.prototype.UPMLST = function() {
    if (this.ZVE.compareTo(Lohnsteuer2022Big.ZAHL1) == -1) {
...
Lohnsteuer2022Big.prototype.MVSP = function() {
    ...
    if (this.PKV > 0) {
        if (this.STKL == 6) {
            ...
            this.VSP3 = this.PKPV.multiply(Lohnsteuer2022Big.ZAHL12).divide(Lohnsteuer2022Big.ZAHL100);
            if (this.PKV == 2) {
...
Lohnsteuer2022Big.prototype.UP5_6 = function() {
    ...
    this.UPTAB22();
    this.ST2 = this.ST;
    this.DIFF = this.ST1.subtract(this.ST2).multiply(Lohnsteuer2022Big.ZAHL2);
...
Lohnsteuer2022Big.prototype.MSOLZ = function() {
    ...
    if (this.JBMG.compareTo(this.SOLZFREI) == 1) {
        this.SOLZJ = this.JBMG.multiply(BigDecimal.valueOf(5.5)).divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
        this.SOLZMIN = this.JBMG.subtract(this.SOLZFREI).multiply(BigDecimal.valueOf(11.9)).divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
        if (this.SOLZMIN.compareTo(this.SOLZJ) == -1) {
            this.SOLZJ = this.SOLZMIN;
        }
        this.JW = this.SOLZJ.multiply(Lohnsteuer2022Big.ZAHL100).setScale(0, BigDecimal.ROUND_DOWN);
        this.UPANTEIL();
    ...
    if (this.R > 0) {
        this.JW = this.JBMG.multiply(Lohnsteuer2022Big.ZAHL100);
        this.UPANTEIL();
...
Lohnsteuer2022Big.prototype.UPANTEIL = function() {
    if (this.LZZ == 1) {
        ...
        if (this.LZZ == 2) {
            this.ANTEIL1 = this.JW.divide(Lohnsteuer2022Big.ZAHL12, 0, BigDecimal.ROUND_DOWN);
        } else {
            if (this.LZZ == 3) {
                this.ANTEIL1 = this.JW.multiply(Lohnsteuer2022Big.ZAHL7).divide(Lohnsteuer2022Big.ZAHL360, 0, BigDecimal.ROUND_DOWN);
            } else {
                this.ANTEIL1 = this.JW.divide(Lohnsteuer2022Big.ZAHL360, 0, BigDecimal.ROUND_DOWN);
            }
        }
    }
}
...
Lohnsteuer2022Big.prototype.MSONST = function() {
    ...
    if (this.SONSTB.compareTo(BigDecimal.ZERO()) == 0 && this.MBV.compareTo(BigDecimal.ZERO()) == 0) {
        ...
        this.ZRE4J = this.JRE4.add(this.SONSTB).divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
        this.ZVBEZJ = this.JVBEZ.add(this.VBS).divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
        this.VBEZBSO = this.STERBE;
        this.MRE4SONST();
        this.MLSTJAHR();
        this.WVFRBM = this.ZVE.subtract(this.GFB).multiply(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
        if (this.WVFRBM.compareTo(BigDecimal.ZERO()) == -1) {
            this.WVFRBM = BigDecimal.ZERO();
        }
        this.UPVKV();
        this.VKVSONST = this.VKV.subtract(this.VKVSONST);
        this.LSTSO = this.ST.multiply(Lohnsteuer2022Big.ZAHL100);
        this.STS = this.LSTSO.subtract(this.LSTOSO).multiply(BigDecimal.valueOf(this.f)).divide(Lohnsteuer2022Big.ZAHL100, 0, BigDecimal.ROUND_DOWN).multiply(Lohnsteuer2022Big.ZAHL100);
        this.STSMIN();
    }
}
...
Lohnsteuer2022Big.prototype.STSMIN = function() {
    if (this.STS.compareTo(BigDecimal.ZERO()) == -1) {
        if (this.MBV.compareTo(BigDecimal.ZERO()) == 0) {
            ...
            this.SOLZLZZ = this.SOLZLZZ.add(this.STS.multiply(BigDecimal.valueOf(5.5).divide(Lohnsteuer2022Big.ZAHL100))).setScale(0, BigDecimal.ROUND_DOWN);
...
Lohnsteuer2022Big.prototype.MSOLZSTS = function() {
    ...
    if (this.SOLZSBMG.compareTo(this.SOLZFREI) == 1) {
        this.SOLZS = this.STS.multiply(BigDecimal.valueOf(5.5)).divide(Lohnsteuer2022Big.ZAHL100, 0, BigDecimal.ROUND_DOWN);
    } else {
        this.SOLZS = BigDecimal.ZERO();
    }
}
...
Lohnsteuer2022Big.prototype.MVMT = function() {
    ...
    if (this.VMT.add(this.VKAPA).compareTo(BigDecimal.ZERO()) == 1) {
        ...
        this.ZRE4J = this.JRE4.add(this.SONSTB).add(this.VMT).add(this.VKAPA).divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
        this.ZVBEZJ = this.JVBEZ.add(this.VBS).add(this.VKAPA).divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
        this.KENNVMT = 2;
        this.MRE4SONST();
        this.MLSTJAHR();
        this.LST3 = this.ST.multiply(Lohnsteuer2022Big.ZAHL100);
        this.MRE4ABZ();
        this.ZRE4VP = this.ZRE4VP.subtract(this.JRE4ENT.divide(Lohnsteuer2022Big.ZAHL100)).subtract(this.SONSTENT.divide(Lohnsteuer2022Big.ZAHL100));
        this.KENNVMT = 1;
        this.MLSTJAHR();
        this.LST2 = this.ST.multiply(Lohnsteuer2022Big.ZAHL100);
        ...
        if (this.STV.compareTo(BigDecimal.ZERO()) == -1) {
            ...
            this.STV = this.STV.multiply(BigDecimal.valueOf(this.f)).divide(Lohnsteuer2022Big.ZAHL100, 0, BigDecimal.ROUND_DOWN).multiply(Lohnsteuer2022Big.ZAHL100);
        }
        this.SOLZVBMG = this.STV.divide(Lohnsteuer2022Big.ZAHL100, 0, BigDecimal.ROUND_DOWN).add(this.JBMG);
        if (this.SOLZVBMG.compareTo(this.SOLZFREI) == 1) {
            this.SOLZV = this.STV.multiply(BigDecimal.valueOf(5.5)).divide(Lohnsteuer2022Big.ZAHL100, 0, BigDecimal.ROUND_DOWN);
        } else {
...
Lohnsteuer2022Big.prototype.MOSONST = function() {
    this.ZRE4J = this.JRE4.divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
    this.ZVBEZJ = this.JVBEZ.divide(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
    this.JLFREIB = this.JFREIB.divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
    this.JLHINZU = this.JHINZU.divide(Lohnsteuer2022Big.ZAHL100, 2, BigDecimal.ROUND_DOWN);
    this.MRE4();
    this.MRE4ABZ();
    this.ZRE4VP = this.ZRE4VP.subtract(this.JRE4ENT.divide(Lohnsteuer2022Big.ZAHL100));
    this.MZTABFB();
    this.VFRBS1 = this.ANP.add(this.FVB.add(this.FVBZ)).multiply(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
    this.MLSTJAHR();
    this.WVFRBO = this.ZVE.subtract(this.GFB).multiply(Lohnsteuer2022Big.ZAHL100).setScale(2, BigDecimal.ROUND_DOWN);
    if (this.WVFRBO.compareTo(BigDecimal.ZERO()) == -1) {
        this.WVFRBO = BigDecimal.ZERO();
    }
    this.LSTOSO = this.ST.multiply(Lohnsteuer2022Big.ZAHL100);
}
...
Lohnsteuer2022Big.prototype.MRE4SONST = function() {
    ...
    this.FVB = this.FVBSO;
    this.MRE4ABZ();
    this.ZRE4VP = this.ZRE4VP.add(this.MBV.divide(Lohnsteuer2022Big.ZAHL100)).subtract(this.JRE4ENT.divide(Lohnsteuer2022Big.ZAHL100)).subtract(this.SONSTENT.divide(Lohnsteuer2022Big.ZAHL100));
    this.FVBZ = this.FVBZSO;
    this.MZTABFB();
    this.VFRBS2 = this.ANP.add(this.FVB).add(this.FVBZ).multiply(Lohnsteuer2022Big.ZAHL100).subtract(this.VFRBS1);
}
...
Lohnsteuer2022Big.prototype.UPTAB22 = function() {
    if (this.X.compareTo(this.GFB.add(Lohnsteuer2022Big.ZAHL1)) == -1) {
        this.ST = BigDecimal.ZERO();
    } else {
        if (this.X.compareTo(BigDecimal.valueOf(14927)) == -1) {
            this.Y = this.X.subtract(this.GFB).divide(Lohnsteuer2022Big.ZAHL10000, 6, BigDecimal.ROUND_DOWN);
            this.RW = this.Y.multiply(BigDecimal.valueOf(1088.67));
            this.RW = this.RW.add(BigDecimal.valueOf(1400));
            this.ST = this.RW.multiply(this.Y).setScale(0, BigDecimal.ROUND_DOWN);
        } else {
            if (this.X.compareTo(BigDecimal.valueOf(58597)) == -1) {
                this.Y = this.X.subtract(BigDecimal.valueOf(14926)).divide(Lohnsteuer2022Big.ZAHL10000, 6, BigDecimal.ROUND_DOWN);
                ...
                this.ST = this.RW.add(BigDecimal.valueOf(869.32)).setScale(0, BigDecimal.ROUND_DOWN);
            } else {
                if (this.X.compareTo(BigDecimal.valueOf(277826)) == -1) {
                    this.ST = this.X.multiply(BigDecimal.valueOf(0.42)).subtract(BigDecimal.valueOf(9336.45)).setScale(0, BigDecimal.ROUND_DOWN);
                } else {
                    this.ST = this.X.multiply(BigDecimal.valueOf(0.45)).subtract(BigDecimal.valueOf(17671.2)).setScale(0, BigDecimal.ROUND_DOWN);
                }
            }
        }
    }
